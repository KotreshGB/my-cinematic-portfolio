        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I'm <span className="text-[#F3DBB3] font-medium">Kotresh GB </span><span className="text-[#F3DBB3] font-medium"></span>, a passionate Full-Stack Developer with a strong foundation in front-end and back-end technologies, focused on building dynamic, responsive, and scalable web applications. I also have experience developing AI-powered solutions using Python, Flask, Gemini AI, machine learning, speech recognition, and Node.js. I'm dedicated to creating high-quality software solutions that drive innovation and deliver meaningful user experiences.
            </motion.p>
