...
const journey: RouteStop[] = [
  ...
  },
  {
    ...
    organization: 'TECHNICAL HUB PVT LTD',
    description: 'Developed full-stack applications using modern web technologies, strengthening frontend, backend, database, and deployment skills.',
  },
  {
    id: '03',
    year: '2023 - 2026',
    title: 'B.E IN INFORMATION SCIENCE',
    organization: 'AITRA INSTITUTE TECHNOLOGY BANGLORE',
    description: 'B.E. in Information Science and Engineering, specializing in Full-Stack Development, Python, AI/ML, and software engineering.',
  },
  {
    id: '04',
    year: '2019 - 2022',
    title: 'DIPLOMA IN CIVIL ENGINEERING',
    organization: 'GOVT POLYTECHNIC HOSADURGA',
    description: 'Diploma in Civil Engineering with a foundation in structural design, surveying, construction, and engineering principles',
  },
];
