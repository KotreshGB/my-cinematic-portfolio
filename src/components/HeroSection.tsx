          ...
          >
            ...
            <motion.div variants={fadeUpVariants} className="mb-4">
              <p
                ...
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                FULL STACK DEVELOPER<span className="text-[#8C6D4F] mx-1">•</span>AI/ML DEVELOPER<span className="text-[#8C6D4F] mx-1">•</span>PYTHON DEVELOPER
              </p>
            </motion.div>
            ...
            >
              ...
              <motion.a
                href="/resume.pdf"
                download="Kotresh-GB-Resume.pdf"
