...
const projects: Project[] = [
  {
    number: '01',
    title: 'Voice-Based 2D AI-Powered Mock Interview Assistant',
    category: 'AI / FULL-STACK APPLICATION',
    description:
      'Developed an AI-powered mock interview platform with voice-based interaction and real-time interview simulation. Integrated Gemini AI for technical questions and response evaluation, with speech recognition, text-to-speech, a 2D animated interviewer, personalized feedback, and performance scoring.',
    githubUrl: '#',
    tech: [
      'Python',
      'Flask',
  ...
  },
  {
    ...
    description:
      'Built a handwritten digit recognition system using deep learning and machine learning algorithms including KNN, SVM, Random Forest, and CNN. Implemented the model using Keras and TensorFlow.',
    githubUrl: '#',
    tech: [
      'Python',
      'KNN',
    ...
    metrics: [
      { label: 'CNN ACCURACY', value: '98.72%' },
    ],
  },
  {
    number: '03',
    ...
    description:
      'Developed an online quiz application with a JavaScript and CSS frontend and Node.js backend. Connected the frontend and backend to manage quiz questions and user scores.',
    githubUrl: '#',
    tech: [
      'JavaScript',
      'CSS',
  ...
  },
  {
    ...
    description:
      'Developed a Python-based chatbot designed to provide users with information about hospitals and doctors through an interactive conversational interface.',
    githubUrl: '#',
    tech: [
      'Python',
      'Chatbot',
  ...
  },
  {
    ...
    description:
      'Developed a hotel booking system using HTML, CSS, JavaScript, and PHP, with MySQL used for storing and managing application data.',
    githubUrl: '#',
    tech: [
      'HTML',
      'CSS',
